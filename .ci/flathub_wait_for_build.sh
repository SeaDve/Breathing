...
URL_RUNNING_BUILDS="https://flathub.org/builds/api/v2/builders/32/builds?complete=false&flathub_name__eq=io.github.seadve.Breathing&order=-number&property=owners&property=workername"
URL_LAST_BUILD="https://flathub.org/builds/api/v2/builders/32/builds?flathub_name__eq=io.github.seadve.Breathing&flathub_repo_status__gt=1&limit=1&order=-number&property=owners&property=workername"
